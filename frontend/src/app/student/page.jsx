...
const Payment = () => {
        ...
        script.onload = () => {
          if (window.ZPayments) {
            const config = {
              ...
              otherOptions: {
                api_key:
                  "1003.fc0c27e5e5a242cec477dcd9b3f67079.2d0043c9b25dcf75880ff00e14a67566",
              },
            };
            try {
  ...
  return (
    <>
     <div className="school-pay max-w-sm mx-auto my-10 bg-gradient-to-br from-pink-600 to-green-400 shadow-2xl rounded-2xl border border-gray-300 overflow-hidden transform transition-transform duration-500 hover:scale-105">
  {/* Header */}
  ...
  <div className="p-8 text-center">
    ...
    <p className="text-lg text-gray-100 mb-6">
      Complete the school fees payment and process it securely.
    </p>
